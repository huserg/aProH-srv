...
<x-modal :id="$id" :maxWidth="$maxWidth" {{ $attributes }}>
    <div class="bg-white dark:bg-black-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
    ...
    <div class="flex flex-row justify-end px-6 py-4 bg-black-100 dark:bg-black-800 text-end">
        {{ $footer }}
    </div>
</x-modal>
